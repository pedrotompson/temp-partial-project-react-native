...
export default function RegisterInvestidor1Screen({ navigation }) {

    useLayoutEffect(() => {
        navigation.setOptions({
            headerRight: () => (
                <PeText h2 light secondary mr4 >1/4</PeText>
            ),
        });
    }, [])
    ...
    const btnFormClick = (values) => {
        ...
        navigation.navigate('RegisterInvestidor2', values);
    };
            ...
            >
                {({ handleChange, handleBlur, handleSubmit, values, errors, isValid, touched, dirty }) => (
                    ...
                    <Style.Container>
                        <Style.Content>
                            <View>
                                <PeText h2 secondary>Olá, investidor.</PeText>
