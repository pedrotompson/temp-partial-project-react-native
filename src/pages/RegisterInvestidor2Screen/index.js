...
export default function RegisterInvestidor2Screen({ route, navigation }) {
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            headerRight: () => (
                <PeText h2 light secondary mr4 >2/4</PeText>
            ),
        });
    }, [])
    ...
    const btnFormClick = (values) => {
        ...
        navigation.navigate('RegisterInvestidor3', values);
    };
    ...
    return (
        ...
        >
            ...
            <Formik
                ...
                initialValues={{ nomeResponsavel: '', sobrenomeResponsavel: '', cpfCnpj: '', dataNascimento: '', telefone: '' }}
            ...
            >
                {({ handleChange, handleBlur, handleSubmit, setFieldValue, values, errors, isValid, touched, dirty }) => (
                    ...
                    <Style.Container>
                        <Style.Content>
                            <PeText h2 secondary>Fale sobre você</PeText>
                            <PeText h2 semibold mb8>Informe seus dados</PeText>
                            ...
                            <PeInput
                                ...
                                enablesReturnKeyAutomatically
                                errorMessage={errors.cpfCnpj && touched.cpfCnpj && errors.cpfCnpj}
                                mask="99999999999"
                                hint="98078756765"
                            />
